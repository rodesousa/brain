...
_Régénéré le 2026-06-26 — 54 pages._
...
- [[glm]] `draft` — Famille de modèles open-weight de Zhipu / Z.ai — orientée coding agents, long-horizon tasks et MoE deployment. GLM-5.2 = MoE 753B, MIT, 1M context.
...
- [[ofox-glm-5-2-local-2026]] `draft` — Guide opérationnel ofox.ai pour faire tourner GLM-5.2 (753B MoE, MIT, 1M context) en local via GGUF Unsloth — hardware, quants, runners, et plaidoyer pour le hébergé.
